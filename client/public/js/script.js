$(document).ready(function(){
    $(".know_more_mobile").click(function(){
        $(".main .profile").toggleClass("animated");
        $(".main .copy").toggleClass("animated");
        $(".main .headline").toggleClass("animated");
        $(".know_more_mobile").css("display", "none");   
        $(".arrow_know_more").css("display", "inline-block");            
        return false;
    });


    $(".nav_icon>i").click(function(){
        $(".navigation_mobile .nav").toggleClass("animated"); 
